 ...
 */
export declare function sanitizeObjKeys(
 ...
 * the given mapping.
 */
export declare function desanitizeObjKeys(
  obj: Object | Array<any>,
  mapping?: Object
): Object | Array<any>
/**
 ...
 */
export declare function instantiatePathAndGetQuery(
  path: string,
 ...
 * does not exist.
 */
export declare function getRequestSchema(
 ...
 */
export declare function getRequestSchemaAndNames(
  path: string,
  method: string,
  oas: Oas3
 ...
 * does not exist.
 */
export declare function getResponseSchema(
  endpoint: OperationObject,
  statusCode: string,
  oas: Oas3
): {
 ...
 * available).
 */
export declare function getResponseSchemaAndNames(
  path: string,
  method: string,
  oas: Oas3,
 ...
 * method (or null).
 */
export declare function getResponseStatusCode(
  path: string,
  method: string,
  oas: Oas3,
  data: PreprocessingData
 ...
 */
export declare function getEndpointLinks(
  path: string,
  method: string,
  oas: Oas3,
  data: PreprocessingData
 ...
 * default.
 */
export declare function getServers(
  path: string,
  method: string,
  oas: Oas3
): ServerObject[]
 ...
 * possible references.
 */
export declare function getSecuritySchemes(
  oas: Oas3
): {
 ...
 */
export declare function getSecurityRequirements(
  path: string,
  method: string,
  securitySchemes: {
 ...
 * the given mapping.
 */
export declare function beautifyAndStore(
  str: string,
  mapping: {
    [key: string]: string
  }
