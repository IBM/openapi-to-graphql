...
function translateOpenApiToGraphQL(
  ...
  return __awaiter(this, void 0, void 0, function*() {
          ...
          if (operation.inViewer) {
            for (let securityRequirement of operation.securityRequirements) {
              ...
              if (
                ...
                fieldName = Oas3Tools.beautifyAndStore(
                  operationId,
                  data.saneMap
                )
              }
    ...
    if (Object.keys(authQueryFields).length > 0) {
      Object.assign(
        queryFields,
        auth_builder_1.createAndLoadViewer(authQueryFields, data, false, oass)
      )
    }
    if (Object.keys(authMutationFields).length > 0) {
      Object.assign(
        mutationFields,
        auth_builder_1.createAndLoadViewer(authMutationFields, data, true, oass)
      )
    }
    /**
     * Build up the schema
