 ...
 * definition.
 */
export declare function createDataDef<TSource, TContext, TArgs>(names: Oas3Tools.SchemaNames, schemaOrRef: SchemaObject | ReferenceObject, isInputObjectType: boolean, data: PreprocessingData<TSource, TContext, TArgs>, oas: Oas3, links?: {
