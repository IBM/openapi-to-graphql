...
exports.createIntScalar = (config) => {
    const { coerce, errorHandler, maximum, minimum, sanitize, validate, serialize } = config, scalarConfig = __rest(config, ["coerce", "errorHandler", "maximum", "minimum", "sanitize", "validate", "serialize"]);
...
//# sourceMappingURL=strict_int.js.map