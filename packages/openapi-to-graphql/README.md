...
- `interceptHttpErrors` (type: boolean, default: true): Enable http errors (<200 or >299) interception by graphqpl wrapper, when disabled it leave status code and body as served by the openapi server.
