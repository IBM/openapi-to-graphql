        ...
        if ('in' in security.def) {
          if (security.def.in === 'header' && typeof security.def.name === 'string') {
            ...
            if (data.options.strict) {
              ...
              var warning = 'Warning: cannot send apiKey in ' + ('"' + JSON.stringify(security.def.in) + '"');
              log(warning);
        ...
        switch (security.def.scheme) {
          ...
          default:
            if (data.options.strict) {
              ...
              var _warning = 'Warning: cannot recognize http security scheme ' + ('\'' + JSON.stringify(security.def.scheme) + '\'');
              log(_warning);
