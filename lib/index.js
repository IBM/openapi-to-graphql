...
/**
 * If this module is run as a command line tool
 *
 * Usage: oasgraph <OAS JSON file path>
 *
 * Creates a server hosting the GraphQL interface generated form the given
 * OpenAPI Specification (2 or 3).
 *
 * NOTE: Mainly used for quick testing. Does not provide the flexibility and
 * functionality of createGraphQlSchema(oas, options)
 */
if (require.main === module) {
    ...
    if (args.length > 0) {
        ...
        try {
            ...
            createGraphQlSchema(oas, { strict: false, viewer: true, addSubOperations: true, sendOAuthTokenInQuery: false, report: {
                    warnings: [],
                    numOps: 0,
                    numOpsQuery: 0,
                    numOpsMutation: 0,
        ...
        console.log('Usage: oasgraph <OAS JSON file path>');
    }
}
/**
